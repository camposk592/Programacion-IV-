...
Vue.component('producto',{
    ...
    methods:{
        ...
        eliminarProducto(producto){
            if( confirm(`Esta seguro de eliminar el libro ${producto.nombre}?`) ){
                ...
                <div class="card-body text-dark">
                    <form method="post" @submit.prevent="guardarProducto" @reset="nuevoProducto">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-2">
                                <input title="Ingrese el Isbn" v-model="producto.isbn" pattern="[0-9]{3,10}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col col-md-2">Titulo:</div>
                            <div class="col col-md-3">
                                <input title="Ingrese el titulo" v-model="producto.titulo" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col col-md-2">Editorial:</div>
                            <div class="col col-md-3">
                                <input title="Ingrese la marca" v-model="producto.editorial" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-3">
                                <input title="Ingrese la edicion" v-model="producto.edicion" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
