Vue.component('categoria',{
    ...
    methods:{
        ...
        eliminarCategoria(categoria){
            if( confirm(`Esta seguro de eliminar el autor ${categoria.nombre}?`) ){
                ...
                <div class="card-body text-dark">
                    <form method="post" @submit.prevent="guardarCategoria" @reset="nuevoCategoria">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-3">
                                <input title="Ingrese el pais" v-model="categoria.pais" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col col-md-2">
                                <input title="Ingrese el numero celular" v-model="categoria.telefono" pattern="[0-8]{3,10}" required type="text" class="form-control">
                            </div>
                        </div>
